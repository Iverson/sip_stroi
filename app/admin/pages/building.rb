ActiveAdmin.register_page "Bulding" do
  title = I18n.t("active_admin.pages.building")
        ...
        fieldset do
          ol do
            li do
              ...
              f.textarea :name => "data[about.building.text]", :class => 'ckeditor_input' do
                SiteSettings['about.building.text']
              end
            end
          end
        end
